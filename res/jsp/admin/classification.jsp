...
<%
    ...
    {%>
    	<div class="success" id="message" style="position:absolute;top:10px;left:300px">	
    		<p>Iris Classification Details Added Successfully.....!</p>
    	</div>			
    <%}
	if(Utility.parse(request.getParameter("no"))==-1)
	{%>
	...
	{%>
		<div class="success" id="message" style="position:absolute;top:10px;left:300px">	
			<p> Iris Classification Details Deleted Successfully.....!</p>
		</div>			
	<%}
	...
	{%>
		<div class="success" id="message" style="position:absolute;top:10px;left:300px">	
			<p>Iris Classification Details Updated Successfully....!</p>
		</div>			
	<%}
%>		
</body>
